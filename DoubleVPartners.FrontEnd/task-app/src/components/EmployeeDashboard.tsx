...
const EmployeeDashboard: React.FC = () => {
  ...
  const fetchTasks = async () => {
    try {
      const response = await fetch(`https://localhost:7198/api/Task/taskByUser/${localStorage.getItem("email")}`, {
        method: "GET",
        headers: {
  ...
  return (
    <div className="dashboard-container">
      <div>
        <h2 className="text-center mb-4">Empleado Task Management</h2>
